...
const Brand = () => {
    return (
        ...
        <h2 className="text-2xl font-bold">Trusted by Leading Real Estate Brands</h2>
        <p className="text-lg mt-2">Top real estate companies rely on us</p>
        <div className="mt-4 border-t border-white w-4/5 mx-auto"></div>
        <Marquee speed={80} className="mt-6">
           <img src={b1} alt="Keller Williams" className="h-16 mx-8" />
