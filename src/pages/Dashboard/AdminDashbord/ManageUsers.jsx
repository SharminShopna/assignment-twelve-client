                        ...
                        {users.map((userData) => (
                            <tr key={userData._id} className="text-center">
                                ...
                                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                                    ...
                                    <button onClick={() =>
                                        handleButtonClick("deleteUser", userData.email)
                                    } className='px-4 py-1 font-bold bg-red-300 text-gray-700 rounded-full ml-4'>Delete</button>

                                    {/* Conditionally render the Fraud button */}
                                    {userData?.role === 'agent' && (
                                        <button className='px-4 py-1 font-bold bg-red-300 text-gray-700 rounded-full ml-4'>Fraud</button>
                                    )}
